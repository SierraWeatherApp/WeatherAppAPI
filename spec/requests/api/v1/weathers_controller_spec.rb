...
RSpec.describe Api::V1::WeathersController do
  ...
  before do
    # get '/api/v1/weather?latitude=52.52&longitude=13.41&temperature=true&weathercode=true&windspeed=true&day=7',
    #     headers: { 'x-device-id' => user.device_id }
    get '/api/v1/weather?latitude=52.52&longitude=13.41&weathercode=true&day=7&temperature_2m_max=true',
        headers: { 'x-device-id' => user.device_id }
  end
